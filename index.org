...
- Generating "commits" in *BitCoin* ("blocks")
  + Gives you money
  + Is artificialy made very difficult
#+begin_src python
fiddle = 0
while True:
...
To find a hash that starts wih 19 zeroes in hexadecimal you need a *lot* of luck. Or ~ $10^{11}$ guesses.
** BitCoin: Git
...
** BitCoin: BitCoin
  ...
  + The *miner* writes the block
    - With some extra work - the 40 (hex-) digit long hash of the new block needs to start with 19 zeros (04/2021)
