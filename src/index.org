...
In order to know the /current/ commit, we need to look at the paper work.
...
digraph D {
    rankdir=LR;
    bgcolor=transparent;
    HEAD [shape=record    label=<<b>.git/HEAD</b>| ref: refs/heads/master> ];
    master [shape=record label=<<b>refs/heads/master</b>| 0x1234...>];
    ...
    cas [ shape = none
          label = <<table border="0" cellspacing="0">
                    ...
                    <tr>
                       <td port="port2" border="1">0x1234</td>
