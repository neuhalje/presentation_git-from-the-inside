...
#+HTML: </div>
*** Multiple Branches: practical application
#+begin_src bash :exports results :results silent
...
#+end_src
*** TODO Merge: practical II/II
#+begin_src dot :file org-gen/nbmr.svg :cmdline -Tsvg :exports results :noweb: yes
<<dot-graph-from-git()>>
#+end_src
#+begin_src bash :exports both :results code
