...
#+html:  <div class="top-left scale-height objectstore-show-l0">
...
#+html:  <div class="top-left scale-height objectstore-show-l1">
#+INCLUDE: "img/objectstore.svg" export html
#+html: </div>
...
#+html:  <div class="top-left scale-height objectstore-show-l2">
#+INCLUDE: "img/objectstore.svg" export html
#+html: </div>
...
#+html:  <div class="top-left scale-height objectstore-show-l3">
#+INCLUDE: "img/objectstore.svg" export html
#+html: </div>
